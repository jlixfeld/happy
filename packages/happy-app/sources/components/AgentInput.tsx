...
const getContextWarning = (contextSize: number, alwaysShow: boolean = false, theme: Theme, contextWindow: number = DEFAULT_MAX_CONTEXT_SIZE) => {
    const maxContextSize = Number.isFinite(contextWindow) && contextWindow > 0 ? contextWindow : DEFAULT_MAX_CONTEXT_SIZE;
